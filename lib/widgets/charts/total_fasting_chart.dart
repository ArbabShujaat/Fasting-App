...
class TotalFastingChart extends StatefulWidget {
  final List<BarChartData> data;

  TotalFastingChart({@required this.data});

  @override
  _TotalFastingChartState createState() => _TotalFastingChartState();
}

class _TotalFastingChartState extends State<TotalFastingChart> {
  int select = 0;
